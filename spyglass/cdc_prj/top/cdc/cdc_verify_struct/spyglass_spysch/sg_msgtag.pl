...
spyParseTextMessageTagFile("./cdc_prj/top/cdc/cdc_verify_struct/spyglass_spysch/sg_msgtag.txt");
...
spyMessageTagTestBenchmark(71,"./cdc_prj/top/cdc/cdc_verify_struct/spyglass.vdb");
